...
namespace space1.States
{
  ...
  public class GameState : State
  {
    ...
    public override void LoadContent()
    {
      ...
      {
        new Sprite(_content.Load<Texture2D>("Background/spaceMenu"))
        {
          Layer = 0.0f,
    ...
    public override void PostUpdate(GameTime gameTime)
    {
      ...
      foreach (var spriteA in collidableSprites)
      {
        ...
        {
          // gör inget om det är samma sprite
          if (spriteA == spriteB)
            continue;
      ...
      // lägg till barnklass sprites till listan av sprites (som bullets)
      ...
      // om alla spelare är döda, vi sparar poängen and går till highscore state
